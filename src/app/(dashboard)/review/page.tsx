...
import { RotateCcw, Clock, Sparkles, Calendar } from 'lucide-react';
import ReviewSession from './ReviewSession';
import { PageHeader } from '../../../components/PageHeader';

export default async function ReviewPage() {
    const dueItems = await getDueReviewItems();
    const hasDueItems = 'items' in dueItems && dueItems.items.length > 0;
    ...
    if (hasDueItems) {
        return <ReviewSession initialItems={dueItems.items} />;
    }
